...
@Getter
@NoArgsConstructor
public class VenuesSaveRequestDto {
    ...
    public Venues toEntity(SessionUser sessionUser){
        return Venues.builder()
                .managerId(sessionUser.getId())
                .name(this.name)
                .type(BuildingType.valueOf(this.buildingType))
                .phone(this.phone)
                .homepageUrl(this.homepageUrl)
                .address_name(this.address_name)
                .region_1depth_name(this.region_1depth_name)
                .region_2depth_name(this.region_2depth_name)
                .region_3depth_name(this.region_3depth_name)
                .road_name(this.road_name)
                .underground_yn(this.underground_yn)
                .main_building_no(this.main_building_no)
                .sub_building_no(this.sub_building_no)
